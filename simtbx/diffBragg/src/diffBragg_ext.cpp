...
namespace simtbx { namespace diffBragg { namespace boost_python { namespace {

void (simtbx::nanoBragg::diffBragg::*add_diffBragg_spots_A)() =
    &simtbx::nanoBragg::diffBragg::add_diffBragg_spots;
void (simtbx::nanoBragg::diffBragg::*add_diffBragg_spots_B)(const nanoBragg::af::shared<size_t>&) =
    &simtbx::nanoBragg::diffBragg::add_diffBragg_spots;
void (simtbx::nanoBragg::diffBragg::*add_diffBragg_spots_C)(
    const nanoBragg::af::shared<size_t>&,
    boost::python::list per_pix_nominal_hkl) = &simtbx::nanoBragg::diffBragg::add_diffBragg_spots;
...
static void set_diffuse_gamma(
    simtbx::nanoBragg::diffBragg& diffBragg,
    boost::python::tuple const& values) {
    ...
    diffBragg.db_cryst.anisoG << g0, 0, 0, 0, g1, 0, 0, 0, g2;
}

static boost::python::tuple get_diffuse_gamma(simtbx::nanoBragg::diffBragg const& diffBragg) {
    return boost::python::make_tuple(
        diffBragg.db_cryst.anisoG(0, 0), diffBragg.db_cryst.anisoG(1, 1),
        diffBragg.db_cryst.anisoG(2, 2));
}

static void set_diffuse_sigma(
    simtbx::nanoBragg::diffBragg& diffBragg,
    boost::python::tuple const& values) {
    ...
    diffBragg.db_cryst.anisoU << sig0 * sig0, 0, 0, 0, sig1 * sig1, 0, 0, 0, sig2 * sig2;
    diffBragg.db_cryst.dU_dsigma.clear();
    diffBragg.db_cryst.dU_dsigma.resize(3);

    for (int i = 0; i < 3; i++) {
        diffBragg.db_cryst.dU_dsigma[i] << 0, 0, 0, 0, 0, 0, 0, 0, 0;
...
void set_rotate_principal_axes(
    simtbx::nanoBragg::diffBragg& diffBragg,
    nanoBragg::mat3 const& value) {
    diffBragg.db_cryst.rotate_principal_axes << value[0], value[1], value[2], value[3], value[4],
...
static void set_fpfdp(
    ...
    boost::python::list fdblprime =
        boost::python::extract<boost::python::list>(fprime_fdblprime[1]);
...
void set_O(simtbx::nanoBragg::diffBragg& diffBragg, nanoBragg::mat3 const& value) {
    ...
    diffBragg.db_cryst.eig_O << value[0], value[1], value[2], value[3], value[4], value[5],
...
void set_U(simtbx::nanoBragg::diffBragg& diffBragg, nanoBragg::mat3 const& value) {
    ...
    diffBragg.db_cryst.eig_U << value[0], value[1], value[2], value[3], value[4], value[5],
        value[6], value[7], value[8];
}
...
void set_B(simtbx::nanoBragg::diffBragg& diffBragg, nanoBragg::mat3 const& value) {
    ...
    diffBragg.db_cryst.eig_B << diffBragg.a0[1], diffBragg.b0[1], diffBragg.c0[1], diffBragg.a0[2],
        diffBragg.b0[2], diffBragg.c0[2], diffBragg.a0[3], diffBragg.b0[3], diffBragg.c0[3];
}
...
static boost::python::tuple get_reference_origin(simtbx::nanoBragg::diffBragg& diffBragg) {
    return boost::python::make_tuple(
        diffBragg.O_reference[0] * 1000, diffBragg.O_reference[1] * 1000,
        diffBragg.O_reference[2] * 1000);
}

// simtbx::nanoBragg::af::shared<double> get_deriv_pix(simtbx::nanoBragg::diffBragg& diffBragg, int
// refine_id){
...
static boost::python::tuple get_origin(simtbx::nanoBragg::diffBragg& diffBragg) {
    return boost::python::make_tuple(
        diffBragg.pix0_vector[1] * 1000, diffBragg.pix0_vector[2] * 1000,
        diffBragg.pix0_vector[3] * 1000);
}
...
static boost::python::tuple get_Fhkl_tuple(simtbx::nanoBragg::diffBragg diffBragg) {
    ...
    diffBragg.pythony_indices =
        nanoBragg::indices(hkls, nanoBragg::af::init_functor_null<scitbx::vec3<int> >());
    diffBragg.pythony_amplitudes =
        nanoBragg::af::shared<double>(hkls, nanoBragg::af::init_functor_null<double>());
    diffBragg.pythony_amplitudes2 =
        nanoBragg::af::shared<double>(hkls, nanoBragg::af::init_functor_null<double>());
    int i = 0;
        ...
        for (k = diffBragg.k_min; k <= diffBragg.k_max; ++k) {
            for (l = diffBragg.l_min; l <= diffBragg.l_max; ++l) {
                if ((h <= diffBragg.h_max) && (h >= diffBragg.h_min) && (k <= diffBragg.k_max) &&
                    ...
                    temp = diffBragg
                               .Fhkl[h - diffBragg.h_min][k - diffBragg.k_min][l - diffBragg.l_min];
                    diffBragg.pythony_amplitudes[i] = temp;
                    if (diffBragg.complex_miller) {
                        temp = diffBragg.Fhkl2[h - diffBragg.h_min][k - diffBragg.k_min]
                                              [l - diffBragg.l_min];
    ...
    if (diffBragg.complex_miller)
        return boost::python::make_tuple(
            diffBragg.pythony_indices, diffBragg.pythony_amplitudes, diffBragg.pythony_amplitudes2);
    else
...
#ifdef DIFFBRAGG_HAVE_KOKKOS
    def("finalize_kokkos", finalize_kokkos, "calls Kokkos::finalize()");

    def("initialize_kokkos", initialize_kokkos,
        "the sole argument `dev` (an int from 0 to Ngpu-1) is passed to Kokkos::initialize()");
#endif

    class_<simtbx::nanoBragg::diffBragg, bases<simtbx::nanoBragg::nanoBragg> >("diffBragg", no_init)
        /* constructor that takes a dxtbx detector and beam model */
        .def(init<const dxtbx::model::Detector&, const dxtbx::model::MonoBeam&, int>(
            (arg_("detector"), arg_("beam"), arg_("verbose") = 0),
        ...
        .def(
            "add_diffBragg_spots", add_diffBragg_spots_A,
            "gives derivative of average photon count w.r.t. parameter of choice")

        .def(
            "add_diffBragg_spots", add_diffBragg_spots_B,
            "gives derivative of average photon count w.r.t. parameter of choice")

        .def(
            "add_diffBragg_spots", add_diffBragg_spots_C,
            "gives derivative of average photon count w.r.t. parameter of choice")

        /* Run this before running add_diffBragg_spots */
        .def("vectorize_umats", &simtbx::nanoBragg::diffBragg::vectorize_umats, "caches the UMATS")

        .def(
            "initialize_managers", &simtbx::nanoBragg::diffBragg::initialize_managers,
            "sets up the managers")

        .def("refine", &simtbx::nanoBragg::diffBragg::refine, "sets the refinement flag to true")

        .def("fix", &simtbx::nanoBragg::diffBragg::fix, "sets the refinement flag to false")

        .def(
            "let_loose", &simtbx::nanoBragg::diffBragg::let_loose,
            "sets the refinement flag to True(but doesnt initialize)")

        .def(
            "get_value", &simtbx::nanoBragg::diffBragg::get_value,
            "get value of the refinement parameter")

        .def(
            "set_value", &simtbx::nanoBragg::diffBragg::set_value,
            "set value of the refinement parameter")

        .def(
            "set_ncells_values", &simtbx::nanoBragg::diffBragg::set_ncells_values,
            "set Ncells values as a 3-tuple (Na, Nb, Nc)")

        .def(
            "get_ncells_values", &simtbx::nanoBragg::diffBragg::get_ncells_values,
            "get Ncells values as a 3-tuple (Na, Nb, Nc)")

        .def(
            "add_diffBragg_spots_full", &simtbx::nanoBragg::diffBragg::add_diffBragg_spots_full,
            "forward model and gradients at every pixel")

        .def(
            "get_ncells_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_ncells_derivative_pixels,
            "get derivatives of intensity w.r.t (Na, Nb, Nc)")

        .def(
            "get_diffuse_gamma_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_diffuse_gamma_derivative_pixels,
            "get derivatives of intensity w.r.t. diffuse (gamma_a, gamma_b, gamma_c)")

        .def(
            "get_diffuse_sigma_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_diffuse_sigma_derivative_pixels,
            "get derivatives of intensity w.r.t. diffuse (sigma_a, sigma_b, sigma_c)")

        .def(
            "get_fp_fdp_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_fp_fdp_derivative_pixels,
            "get derivatives of intensity w.r.t c,d that describe fprime and fdblprime (see diffBragg.utils)")

        .def(
            "get_ncells_def_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_ncells_def_derivative_pixels,
            "get derivatives of intensity w.r.t (Nd, Ne, Nf)")

        //.def("get_Na_derivative_pixels", &simtbx::nanoBragg::diffBragg::get_Na_derivative_pixels,
        //"get derivatives of intensity w.r.t (Nd, Ne, Nf)")

        .def(
            "get_aniso_eta_deriv_pixels", &simtbx::nanoBragg::diffBragg::get_aniso_eta_deriv_pixels,
            "get derivatives of intensity w.r.t anisotropic mosaicity model")

        .def(
            "get_aniso_eta_second_deriv_pixels",
            &simtbx::nanoBragg::diffBragg::get_aniso_eta_second_deriv_pixels,
            "get second derivatives of intensity w.r.t anisotropic mosaicity model")

        .def(
            "get_ncells_def_second_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_ncells_def_second_derivative_pixels,
            "get 2nd derivatives of intensity w.r.t (Nd, Ne, Nf)")

        .def(
            "get_ncells_second_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_ncells_second_derivative_pixels,
            "get second derivatives of intensity w.r.t (Na, Nb, Nc)")

        .def(
            "get_lambda_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_lambda_derivative_pixels,
            "get derivatives of intensity w.r.t (lambda0, lambda1) as a 2-tuple")

        .def(
            "print_if_refining", &simtbx::nanoBragg::diffBragg::print_if_refining,
            "print a statement if the refiner flag is set")

        .def(
            "quick_Fhkl_update", &simtbx::nanoBragg::diffBragg::quick_Fcell_update,
            "update Fcell amplitudes without reallocating memory")
        .def(
            "update_xray_beams", &simtbx::nanoBragg::diffBragg::update_xray_beams,
            "update xray beams without reallocating memory")

        .def(
            "set_ucell_derivative_matrix",
            &simtbx::nanoBragg::diffBragg::set_ucell_derivative_matrix, "Boo-ya")

        .def(
            "set_ucell_second_derivative_matrix",
            &simtbx::nanoBragg::diffBragg::set_ucell_second_derivative_matrix, "Two-ya")

        //.def("get_ucell_derivative_matrix",
        //&simtbx::nanoBragg::diffBragg::get_ucell_derivative_matrix, "scooby snacks")

        //.def("get_derivative_pixels", get_deriv_pix,
        //      "gets the manager raw image containing first derivatives")

        .def(
            "__add_Fhkl_gradients", &simtbx::nanoBragg::diffBragg::add_Fhkl_gradients,
        ...
        .def(
            "__update_Fhkl_scale_factors", &simtbx::nanoBragg::diffBragg::update_Fhkl_scale_factors,
            "updates the scale factors for each ASU. Should be same length as the db_cryst.ADUid_map")

        .def(
            "__update_Fhkl_channels", &simtbx::nanoBragg::diffBragg::update_Fhkl_channels,
        ...
        .def(
            "get_Fhkl_channels", &simtbx::nanoBragg::diffBragg::get_Fhkl_channels,
            "get current list of Fhkl channels (if set, it will be the same length as number of sources)")

        .def(
            "__get_derivative_pixels", &simtbx::nanoBragg::diffBragg::get_derivative_pixels,
            "gets the manager raw image containing first derivatives")

        .def(
            "get_second_derivative_pixels",
            &simtbx::nanoBragg::diffBragg::get_second_derivative_pixels,
            "gets the manager raw image containing second derivatives")

        .def(
            "zero_raw_pixel_rois", &simtbx::nanoBragg::diffBragg::zero_raw_pixel_rois,
            "reallocate the raw image ROIs (they are usually tiny)")

        .def("get_origin", get_origin, "get panel origin")

        .def(
            "shift_origin_z", &simtbx::nanoBragg::diffBragg::shift_originZ,
            "shift the Z-component of the pixel0 vector in every detector panel")

        .def(
            "update_dxtbx_geoms", &simtbx::nanoBragg::diffBragg::update_dxtbx_geoms,
            (arg_("detector"), arg_("beam"), arg_("panel_id") = 0, arg_("panel_rot_angO") = 0,
             arg_("panel_rot_angF") = 0, arg_("panel_rot_angS") = 0, arg_("panel_offsetX") = 0,
             arg_("panel_offsetY") = 0, arg_("panel_offsetZ") = 0, arg_("force") = true),
        ...
        .def(
            "set_mosaic_blocks_prime", &simtbx::nanoBragg::diffBragg::set_mosaic_blocks_prime,
            "enter a list of unitary matrix derivatives Uprime")

        .def(
            "set_mosaic_blocks_dbl_prime",
            &simtbx::nanoBragg::diffBragg::set_mosaic_blocks_dbl_prime,
            "enter a list of unitary matrix 2nd derivatives Uprime")

        .def(
            "show_timings", &simtbx::nanoBragg::diffBragg::show_timing_stats,
            (arg_("MPI_RANK") = 0),
        ...
        .add_property("close_distances", make_function(&get_close_distances, rbv()))
        //"get the effective detector distance for each panel")

        .add_property(
            "raw_pixels_roi", make_getter(&simtbx::nanoBragg::diffBragg::raw_pixels_roi, rbv()),
            make_setter(&simtbx::nanoBragg::diffBragg::raw_pixels_roi, dcp()),
            "raw pixels from region of interest only")

        .add_property(
            "oversample_omega", make_getter(&simtbx::nanoBragg::diffBragg::oversample_omega, rbv()),
        ...
        .add_property(
            "force_cpu", make_getter(&simtbx::nanoBragg::diffBragg::force_cpu, rbv()),
        ...
        .add_property(
            "track_Fhkl", make_getter(&simtbx::nanoBragg::diffBragg::track_Fhkl, rbv()),
            make_setter(&simtbx::nanoBragg::diffBragg::track_Fhkl, dcp()),
            "whether to track Fhkl per pixel")

        .add_property(
            "fprime_fdblprime", make_function(&get_fpfdp, rbv()), make_function(&set_fpfdp, dcp()),
            "fprime and fdoubleprime, passed as two lists whose length should be the same")

        .add_property(
            "fprime_fdblprime_derivs",
        ...
        .add_property(
            "heavy_atom_data", make_function(&get_atom_data, rbv()),
        ...
        .add_property(
            "no_Nabc_scale", make_getter(&simtbx::nanoBragg::diffBragg::no_Nabc_scale, rbv()),
        ...
        .add_property(
            "__number_of_pixels_modeled_using_diffBragg",  // protect this by making it a long name
        ...
        .add_property(
            "reference_origin", make_function(&get_reference_origin, rbv()),
            make_function(&set_reference_origin, dcp()),
            "reference origin for doing panel rotations for a group of panels")

        .add_property(
            "Umatrix", make_function(&get_U, rbv()), make_function(&set_U, dcp()),
            "rotation portion of Amatrix (dxtbx format, C.get_U())")

        .add_property(
            "laue_group_num", make_function(&get_laue_group_num, rbv()),
        ...
        .add_property(
            "stencil_size", make_function(&get_stencil_size, rbv()),
        ...
        .add_property(
            "Bmatrix", make_function(&get_B, rbv()), make_function(&set_B, dcp()),
            "unit cell portion of Amatrix (dxtbx format; C.get_B())")

        .add_property(
            "Omatrix", make_function(&get_O, rbv()), make_function(&set_O, dcp()),
            "change of basis Omatrix")

        .add_property(
            "Ncells_abc", make_function(&get_Nabc, rbv()), make_function(&set_Nabc, dcp()),
            "number of mosaic domains along an axis")

        .add_property(
            "Ncells_def", make_function(&get_Ndef, rbv()), make_function(&set_Ndef, dcp()),
            "off-axis components in mosaic domain size matrix")

        .add_property(
            "Ncells_abc_aniso", make_function(&get_Nabc_aniso, rbv()),
        ...
        .add_property(
            "isotropic_ncells", make_getter(&simtbx::nanoBragg::diffBragg::isotropic_ncells, rbv()),
        ...
        .add_property(
            "Fhkl_tuple", make_function(&get_Fhkl_tuple, rbv()),
        ...
        .add_property(
            "lambda_coefficients", make_function(&get_lambda_coef, rbv()),
        ...
        // CUDA PROPERTIES
        .add_property(
            "use_cuda", make_getter(&simtbx::nanoBragg::diffBragg::use_cuda, rbv()),
            make_setter(&simtbx::nanoBragg::diffBragg::use_cuda, dcp()), "use GPU acceleration")

        .add_property(
            "record_time", make_getter(&simtbx::nanoBragg::diffBragg::record_time, rbv()),
            make_setter(&simtbx::nanoBragg::diffBragg::record_time, dcp()),
            "store timing data for key aspects of the code")

        .add_property(
            "Npix_to_allocate", make_getter(&simtbx::nanoBragg::diffBragg::Npix_to_allocate, rbv()),
        ...
        .add_property(
            "use_diffuse", make_function(&get_use_diffuse, rbv()),
            make_function(&set_use_diffuse, dcp()), "sim with diffuse")

        .add_property(
            "gamma_miller_units", make_function(&get_gamma_miller_units, rbv()),
            make_function(&set_gamma_miller_units, dcp()),
            "use Miller index units for gamma parameters")

        .add_property(
            "only_diffuse", make_function(&get_only_diffuse, rbv()),
            make_function(&set_only_diffuse, dcp()), "sim with ONLY diffuse")

        .add_property(
            "refine_Icell", make_function(&get_refine_Icell, rbv()),
        ...
        .add_property(
            "diffuse_gamma", make_function(&get_diffuse_gamma, rbv()),
            make_function(&set_diffuse_gamma, dcp()), "the 3 diffuse gamma factors")

        .add_property(
            "diffuse_sigma", make_function(&get_diffuse_sigma, rbv()),
            make_function(&set_diffuse_sigma, dcp()), "set the 3 diffuse sigma factors")

        .add_property(
            "_ext_rotate_principal_axes", make_function(&get_rotate_principal_axes, rbv()),
...
}}}}  // namespace simtbx::diffBragg::boost_python
